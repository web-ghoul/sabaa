...
const AddJobForm = ({ formik }: FormiksTypes) => {
  const { formsLoading, handleCloseAddJobModal } = useContext(FormsContext);
  return (
    <Box
    ...
    >
      ...
      <Box className={`flex justify-center items-center gap-4`}>
        ...
        <PrimaryButton className={`!bg-error`} onClick={handleCloseAddJobModal}>
          Cancel
        </PrimaryButton>
      </Box>
    </Box>
