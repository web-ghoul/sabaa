...
const sectionClasses = `grid justify-stretch items-start gap-4 grid-cols-2 md:grid-cols-1 md:gap-3 sm:!gap-2`;
                  ...
                  series={[
                    {
                      ...
                      data: [
                        ...
                        { label: "Owners", value: ownersCounter.ownersCounter },
