...
@Module({
  imports: [MongooseModule.forFeature([{ name: 'Natwasal', schema: NatwasalSchema }, { name: 'Company', schema: CompanySchema },{ name: 'Owner', schema: OwnerSchema },{ name: 'Employee', schema: EmployeeSchema },{ name: ActivityLog.name, schema: ActivityLogSchema },])],
