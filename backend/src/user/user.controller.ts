...
export class UserController {
  ...
  @Get()
  listUsers(@Query('limit') limit: number, @Query('page') page: number, @Query('search') search: string, @Query('sort') sort: string): Promise<User[]> {
    return this.userService.listUsers(limit, page, search,sort);
  }
