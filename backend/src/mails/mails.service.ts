...
export class MailsService {
    ...
    constructor(private mailerService: MailerService, private verificationCodeGenerator: VerificationCodeGenerator,@InjectModel('ResetOtp') private resetOtpModel: Model<ResetOtp> ) {
        
        this.from = "amr.khaled@switch-advertising.com"
    }
