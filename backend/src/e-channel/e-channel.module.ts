...
@Module({
  imports: [MongooseModule.forFeature([{ name: 'EChannel', schema: EChannelSchema },{ name: ActivityLog.name, schema: ActivityLogSchema },{ name: Employee.name, schema: EmployeeSchema},{ name: Owner.name, schema: OwnerSchema}])],
